...
controller('MainCtrl', ['$scope', '$http', '$timeout', '$q', function ($scope, $http, $timeout, $q) {
    ...
    $scope.getFirstData = function () {
        var promise = $q.defer();
        $http.get('https://raw.githubusercontent.com/angular-ui/ui-grid/master/misc/site/data/10000_complex.json')
